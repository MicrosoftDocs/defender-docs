...
1.  In the **JIT VM access configuration**, you can edit the list of ports or select **Add** for a new custom port.
...
To request access to a JIT-enabled VM using PowerShell:
