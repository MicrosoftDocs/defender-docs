...
| Aspect | Details |
|--|--|
| Registries and images | **Supported**<br> * Container images in Docker V2 format  <br> * Container images in Minimus format  <br> * Container images in Photon OS format (versions 2.0-5.0) <br> * Images with [Open Container Initiative (OCI)](https://github.com/opencontainers/image-spec/blob/main/spec.md) image format specification <br>  **Unsupported**<br> * Super-minimalist images such as [Docker scratch](https://hub.docker.com/_/scratch/) images is currently unsupported <br> * Public repositories <br> * Manifest lists <br>|
