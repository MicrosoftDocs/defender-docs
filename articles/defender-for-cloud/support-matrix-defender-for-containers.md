...
| Anti-malware | Detection of malware | AKS | GA | - | Requires **Defender sensor via Helm** | **Defender for Containers** | Commercial clouds |
...
| Anti-malware | Detection of malware | EKS | GA | - | Requires **Defender sensor via Helm** | **Defender for Containers** | Commercial clouds |
...
| Anti-malware | Detection of malware | GKE | GA | - | Requires **Defender sensor via Helm** | **Defender for Containers** | Commercial clouds |
