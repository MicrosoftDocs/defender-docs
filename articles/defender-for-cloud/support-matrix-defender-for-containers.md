...
| Agentless machine scanning | Vulnerability assessment of node| AKS| GA | GA |Enable **Agentless scanning for machines** | Agentless | Defender for Containers or Defender for Servers P2 or CSPM | Azure **??** |
...
| Node | [Detect malware in node VM](kubernetes-nodes-malware.md) | AKS | GA | GA | Enable **Agentless scanning for machines** option  | Agentless | Defender for Containers or Defender for Servers P2 | Azure **???** |
