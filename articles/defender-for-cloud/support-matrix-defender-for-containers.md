...
| Binary drift prevention | Prevents binary drift in runtime containers | AKS | Preview | Preview |Requires **Defender sensor** | **Defender for Containers** | Commercial clouds |
...
| Anti-malware | Detection of malware | AWS | Preview | Preview | Requires **Defender sensor via Helm** | **Defender for Containers** | Commercial clouds |
...
| Binary drift prevention | Prevents binary drift in runtime containers | EKS | Preview | Preview |Requires **Defender sensor** | **Defender for Containers** | AWS |
...
| Anti-malware | Detection of malware | GKE | Preview | Preview | Requires **Defender sensor via Helm** | **Defender for Conatiners** | Commercial clouds |
...
| Binary drift prevention | Prevents binary drift in runtime containers | AKS | Preview | Preview |Requires **Defender sensor** | **Defender for Containers** | GCP |
...
| Binary drift prevention | Prevents binary drift in runtime containers | | - | - | - | - |
