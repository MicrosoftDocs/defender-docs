...
| **System updates and patches** | [Azure Update Manager remediation of unhealthy resources and recommendations](enable-periodic-system-updates.md) is available at no additional cost for Arc enabled machines. | Not supported in Plan 1 | :::image type="icon" source="./media/icons/yes-icon.png"::: |
