...
--- | --- | --- | ---
**Turn on for a subscription** | Yes | This is the recommended option and can be turned on in the portal. [Learn about plan features](defender-for-servers-overview.md#defender-for-servers-plans).<br/><br/> You can also turn the plan off for an entire subscription in the portal.
...
in [Update Pricings](/rest/api/defenderforcloud/pricings/update?view=rest-defenderforcloud-2024-01-01&tabs=HTTP#update-pricing-on-resource-(example-for-virtualmachines-plan)), use a PUT request to set the pricingTier property to *standard* and the subPlan to **P1**.
