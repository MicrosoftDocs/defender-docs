...
Configuring email notifications allows for the delivery of timely notifications to the appropriate recipients. When you modify the email notification settings, you can define preferences for the severity levels of alerts.  Notifications focus on real, exploitable threats rather than broad scenarios. You can also define preferences for the risk level of attack paths that trigger notifications. By default, subscription owners receive email notifications for high-severity alerts and attack paths.
