...
- **[Agentless discovery for Kubernetes](defender-for-containers-enable-plan.md#enablement-method-per-capability)** - provides zero footprint, API-based discovery of your Kubernetes clusters, their configurations, and deployments.
