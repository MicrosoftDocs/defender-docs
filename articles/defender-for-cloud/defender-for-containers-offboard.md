...
| Workload runtime threat protection  <br/><br/> Kubernetes data plane hardening              | Defender  sensor                                             | Remove the Defender sensor per cluster using the [Azure portal, Azure CLI, or REST API](defender-for-containers-enable.md#remove-the-defender-sensor) | Safe to remove      |
