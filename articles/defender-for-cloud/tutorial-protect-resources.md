...
Follow the guidance in [Secure your management ports with just-in-time access](enable-just-in-time-access.md
).
...
> [Manage and respond to alerts](manage-respond-alerts.md)
