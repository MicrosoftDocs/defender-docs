...
**OS system updates** | No plan required | Defender for Servers uses the free foundational posture capabilities of Defender for Cloud that collects information about OS system updates from VMs and checks the information against standards in the Microsoft Cloud Security Benchmark.<br/><br/> This feature uses Azure Update Manager.
**Free OS update remediation** | Plan 2 | When Defender for Servers Plan 2 is enabled, there's no charge for assessing and remediating system updates on Azure Arc machines. [Learn more](/azure/update-center/update-manager-faq#im-a-defender-for-server-customer-and-use-update-recommendations-powered-by-azure-update-manager-namely-periodic-assessment-should-be-enabled-on-your-machines-and-system-updates-should-be-installed-on-your-machines-would-i-be-charged-for-azure-update-manager) is available at no additional cost for Arc enabled machines.
