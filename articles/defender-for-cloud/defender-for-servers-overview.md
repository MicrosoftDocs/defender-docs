...
**Defender for Endpoint automatic onboarding** | Supported in Plan 1 and 2 |  Defender for Cloud [automatically onboards machines to Defender for Endpoint](enable-defender-for-endpoint.md) by installing the Defender for Endpoint sensor on connected machines.
