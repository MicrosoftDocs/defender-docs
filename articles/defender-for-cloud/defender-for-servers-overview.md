...
**Vulnerability scanning (agent-based)** | Supported in Plan 1 and 2 | With the Defender for Endpoint agent, Defender for Servers [assesses machines for vulnerabilities](auto-deploy-vulnerability-assessment.md) with Defender Vulnerability Management.
