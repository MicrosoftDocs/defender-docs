...
**OS system updates** | No plan required | Defender for Servers uses the free foundational posture capabilities of Defender for Cloud to assess whether VMs have the latest updates installed. [Learn more](recommendations-apply-operating-system-updates.md).
