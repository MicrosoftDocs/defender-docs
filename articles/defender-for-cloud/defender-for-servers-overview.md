...
**File integrity monitoring** | Plan 2 | [File integrity monitoring](file-integrity-monitoring-overview.md) examines files and registries for changes that might indicate an attack.<br/><br/> File integrity monitoring previously used the MMA to collect machine information. This method will be deprecated in November 2024. It will replaced by use of the Defender for Endpoint sensor integrated into Defender for Server, available for preview around September 2024.
