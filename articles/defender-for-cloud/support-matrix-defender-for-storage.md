...
- Storage accounts that belong to resource group with the following names are not supported: App_Browsers, App_Code, App_Data, App_GlobalResources, App_LocalResources, App_Themes, App_WebReferences, Bin
