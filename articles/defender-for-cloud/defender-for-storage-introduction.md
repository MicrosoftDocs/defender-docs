...
Defender for Storage prevents malicious files distribution by scanning files on-upload and on-demand, sensitive data exfiltration, and data corruption, ensuring the security and integrity of your data and workloads.
