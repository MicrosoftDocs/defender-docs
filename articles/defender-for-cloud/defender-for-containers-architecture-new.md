...
- **Amazon ECR integration**: Agentless vulnerability assessment for container images stored in Amazon Elastic Container Registry (ECR). Images are scanned automatically when pushed to the registry, providing security findings seamlessly integrated into Defender for Cloud.
