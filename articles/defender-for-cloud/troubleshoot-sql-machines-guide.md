...
The recommendation is only updated every 12 hours. To check the realtime status of your machine, you must [verify the protection of each SQL server](verify-machine-protection.md#verify-protection-on-a-single-sql-server-vm) and perform any troubleshooting necessary.
