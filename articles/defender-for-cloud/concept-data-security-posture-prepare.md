...
| Other costs | Sensitive data discovery for Azure Storage accounts depends on other Azure services. This dependence might result in extra costs, including Azure Storage read operations. |
