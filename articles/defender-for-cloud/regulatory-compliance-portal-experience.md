---
title: Regulatory compliance in Microsoft Defender for Cloud - Portal Experience
description: Learn how to improve regulatory compliance in Microsoft Defender for Cloud using both the Defender portal and Azure portal.
ms.topic: tutorial
ms.date: 10/23/2025
zone_pivot_groups: defender-portal-experience
---

# Regulatory compliance - Portal Experience
...
## Access regulatory compliance in Defender portal

1. Sign in to the [Microsoft Defender portal](https://security.microsoft.com/).

2. In the navigation pane, select **Cloud security** > **Regulatory compliance**.

3. The regulatory compliance dashboard displays all your compliance standards and their status.
...
1. In the Defender portal, navigate to **Cloud security** > **Regulatory compliance**.

    :::image type="content" source="./media/regulatory-compliance-dashboard/compliance-drilldown.png" alt-text="Screenshot that shows the exploration of the details of compliance with a specific standard in Defender portal." lightbox="media/regulatory-compliance-dashboard/compliance-drilldown.png":::
...
3. Select **Control details**.
    ...
    :::image type="content" source="media/regulatory-compliance-dashboard/control-detail.png" alt-text="Screenshot that shows you where to navigate to select control details in Defender portal." lightbox="media/regulatory-compliance-dashboard/control-detail.png":::
...
4. Under **Your Actions**, you can select a down arrow to view more details and resolve the recommendation for that resource.
    ...
    :::image type="content" source="media/regulatory-compliance-dashboard/down-arrow.png" alt-text="Screenshot that shows you where the down arrow is on the screen in Defender portal."  lightbox="media/regulatory-compliance-dashboard/down-arrow.png":::
...
## Access regulatory compliance in Azure portal

1. Sign in to the [Azure portal](https://portal.azure.com/).

2. Search for and select **Microsoft Defender for Cloud**.

3. In the left navigation pane, select **Regulatory compliance**.

4. The regulatory compliance dashboard displays all your compliance standards and their status.
...
1. In Microsoft Defender for Cloud, select **Regulatory compliance** from the left navigation.

    :::image type="content" source="./media/regulatory-compliance-dashboard/compliance-drilldown.png" alt-text="Screenshot that shows the exploration of the details of compliance with a specific standard in Azure portal." lightbox="media/regulatory-compliance-dashboard/compliance-drilldown.png":::
...
1. In the Azure portal, navigate to **Microsoft Defender for Cloud** > **Regulatory compliance**.

2. Select a regulatory compliance standard, and select a compliance control to expand it.

3. Select **Control details**.

    :::image type="content" source="media/regulatory-compliance-dashboard/control-detail.png" alt-text="Screenshot that shows you where to navigate to select control details in Azure portal." lightbox="media/regulatory-compliance-dashboard/control-detail.png":::
...
4. Under **Your Actions**, you can select a down arrow to view more details and resolve the recommendation for that resource.
    ...
    :::image type="content" source="media/regulatory-compliance-dashboard/down-arrow.png" alt-text="Screenshot that shows you where the down arrow is on the screen in Azure portal."  lightbox="media/regulatory-compliance-dashboard/down-arrow.png":::
...
4. Select a particular resource to view more details and resolve the recommendation for that resource. <br>For example, in the **Azure CIS 1.1.0** standard, select the recommendation **Disk encryption should be applied on virtual machines**.
