...
| ------------ | -------- | ------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
|June 1||Alert|Upcoming deprecation|The following [alert ](https://learn.microsoft.com/en-us/azure/defender-for-cloud/alerts-resource-manager#usage-of-powerzure-function-to-maintain-persistence-in-your-azure-environment) will be deprecated since the method is no longer supported in PowerZure<br/>* Usage of PowerZure function to maintain persistence in your Azure environment|
