...
| ------------ | -------------- | -------------------- | ------------------------------------------------------------ |
| December 3, 2025 | Recommendation | Upcoming deprecation (30 day notice) | The following recommendation is set for deprecation 30 days from now: `Microsoft Defender` <br> `for SQL status should be protected for Arc-enabled SQL Servers` for Defender for SQL Servers on Machines plan. |
