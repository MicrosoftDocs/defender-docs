...
| December 1, 2025  | Recommendation | Preview              | [(Preview) Overly permissive permissions should not be configured on Function App, Web App or Logic App](recommendations-reference-serverless-protection.md#preview-overly-permissive-permissions-should-not-be-configured-on-function-app-web-app-or-logic-app) |
