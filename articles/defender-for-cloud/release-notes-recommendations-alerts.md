...
| ------------ | ------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| April 20 | Alert                          | Preview                                                      | [AI - Suspicious anomaly detected in sensitive data exposed by AI resource](preview-alerts-ai-workloads.md#suspicious-anomaly-detected-in-sensitive-data-exposed-by-an-ai-resource) , this replaces the previous sensitive data exposure alert |
