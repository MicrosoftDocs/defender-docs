...
|[Asset inventory](asset-inventory.md) | GA | GA | NA |
|[Security recommendations](security-policy-concept.md) based on the [Microsoft Cloud Security Benchmark](concept-regulatory-compliance.md)  | GA | GA | NA |
|[Recommendation exemptions](exempt-resource.md) | Preview | NA | NA |
|[Secure score](secure-score-security-controls.md) | GA | GA | NA |
...
| [Workbooks](custom-dashboards-azure-workbooks.md) |GA|GA|NA|
...
|[Defender for Containers](defender-for-containers-introduction.md)<br/>[Review detailed feature support](support-matrix-defender-for-containers.md) | GA | GA | NA|
|[DevOps Security](defender-for-devops-introduction.md) | GA | NA | NA|
|[Defender for Domain Name System (DNS)](defender-for-dns-introduction.md) | GA | GA | NA|
...
| [Defender for Azure SQL database servers](defender-for-sql-introduction.md) | GA | GA | NA|
| [Defender for SQL servers on machines](defender-for-sql-servers-introduction.md) | GA | GA | NA |
| [Defender for SQL Servers on Machines](defender-for-sql-introduction.md) | GA | GA | NA |
| [Vulnerability assessment](sql-azure-vulnerability-assessment-overview.md) Express and Classic configurations | GA | GA | NA |
| [Advanced threat protection](/azure/azure-sql/database/threat-detection-overview?view=azuresql&preserve-view=true) | GA | GA | NA |
| [Defender for Open-Source Relational Databases](defender-for-databases-introduction.md) | GA | GA | NA |
