...
| **EntitySource** | Mandatory | string | The data source or connector that provided the entity record. Support sources include:<br>- `Azure`<br>- `Microsoft365`<br>- `AWS`<br>- `GCP`<br>- `Other`<br> Use `Other` if the source is not listed. |
