...
- Appropriate permissions to create and manage data connectors
- Access to the external data source you want to federate
...
## Access federated data connectors

Federation connectors are managed on the Data connectors page in Microsoft Sentinel.
...
1. If creating a new storage account, ensure the **Hierarchical namespaces** setting is enabled.
...
1. On the **Data federation** > **Catalog** page, select the **ADLS Gen 2** row.
...
After selecting **Connect**, the wizard closes and the instance count for ADLS Gen 2 increases.
