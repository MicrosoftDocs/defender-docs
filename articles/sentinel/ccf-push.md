...
- Microsoft Entra permissions:
    ...
    - Permission to create an application with secrets. Note: The connector will fail if Entra applications cannot be created with secrets due to security reasons.
