...
To estimate your expected Microsoft Sentinel costs, use the [Microsoft Sentinel cost estimator tool,](https://microsoft.com/en-us/security/pricing/microsoft-sentinel/cost-estimator) and [work directly with a Security sales specialist](https://info.microsoft.com/ww-landing-microsoft-defender-contact-me.html) for a custom quote or additional guidance.
