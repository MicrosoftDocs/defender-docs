...
|  |[Basic Logs/Archive](/azure/azure-monitor/logs/logs-table-plans)  |[Azure Data Explorer (ADX)](/azure/data-explorer/data-explorer-overview)  |[Azure Blob Storage](/azure/storage/blobs/storage-blobs-overview) |[ADX + Azure Blob Storage](/azure/azure-monitor/logs/azure-data-explorer-query-storage) |
|---------|---------|---------|---------|---------|
