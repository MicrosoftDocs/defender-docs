...
1. Use the map features to explore.
    ...
    - **Search**: Helps you to discover items by node type, and by selecting **all results**, search the particular type for specific results. You can also filter your search by devices, identity, or cloud assets from the initial screen.
