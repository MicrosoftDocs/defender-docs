...
3. Above the title of the article, select ![More options icon.](media/quick-update-more-options-button-on-learn-page.png) **More options** \> ![Edit icon.](media/quick-update-learn-edit-icon.png) **Edit**.

   ![Screenshot of how to get to the Edit button on a learn.microsoft.com article.](media/quick-update-edit-button-on-learn-page.png)
