...
Review the site specific data in the sites list table. Selecting an individual site opens the site pane which shows details and some data about the specific site.
