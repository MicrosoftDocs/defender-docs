...
> [!IMPORTANT]
>Starting March 2, 2025, new Microsoft Defender for Identity tenants can only configure permissions through Microsoft Defender XDR [Unified role-based access control (RBAC)](../defender-xdr/manage-rbac.md). Tenants with roles assigned or exported before this date will retain their current configuration.
