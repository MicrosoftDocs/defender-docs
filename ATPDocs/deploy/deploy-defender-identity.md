...
|---------|---------|---------|
|Connectivity requirements|[Requires connectivity](prerequisites.md#required-ports) to `*.atp.azure.com`|[Requires MDE streamlined URLs](../../defender-endpoint/configure-device-connectivity.md)|
