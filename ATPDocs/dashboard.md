...
|**ITDR deployment health**     |  Lists any sensor deployment progress, any health alerts, and license availability dervied from Defender for Identity and Defender for Endpoint.     |
