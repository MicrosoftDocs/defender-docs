...
|**ITDR deployment health**     |  Lists any sensor deployment progress, any health alerts, and license availability derived from Defeder for Identity data and Device Inventory, which relies on Defender for Endpoint coverage.  |
