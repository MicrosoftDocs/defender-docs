...
## Remediation for Change password for Microsoft Entra seamless SSO account
...
## Remediation for Rotate password for Microsoft Entra Connect AD DS Connector account
...
## Remediation for Remove unnecessary replication permissions for Microsoft Entra Connect AD DS Connector account
...
## Remediation for Remove unsafe permissions on sensitive Microsoft Entra Connect accounts
...
1. Review the list of exposed entities to identify accounts with unsafe permissions. For example:
    ...
    :::image type="content" source="../media/remove-unsafe-permissions-sensitive-entra-connect/screenshot-of-exposed-entities.png" alt-text="Screenshot of exposed entitities.":::
...
## Remediation for Replace Enterprise or Domain Admin account for Microsoft Entra Connect AD DS Connector account
