---
title: 'Security assessment: Assign multifactor authentication for Okta privileged user accounts '
...
# Security assessment: Assign multifactor authentication for Okta privileged user accounts
