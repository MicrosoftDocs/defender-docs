...
> [!NOTE]
>  This security assessment will only be available if Microsoft Defender for Endpoint has detected eligible ADFS servers in the environment.
...
1. Review the recommended action at https://security.microsoft.com/securescore?viewid=actions to discover which of your ADFS servers are unmonitored.
    ...
    :::image type="content" source="media/unmonitored-adfs-server/recommended-actions-unmonitored-adfs-server.png" alt-text="Screenshot that shows the recommended actions for an unmonitoredADFS server.":::
