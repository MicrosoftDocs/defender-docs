...
> [!NOTE]  There are some limitations for Microsoft Entra ID when performing certain actions on other roles. See the [Graph API documentation](/graph/api/resources/users?view=graph-rest-1.0).
