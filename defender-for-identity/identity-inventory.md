...
| Used by AI agents (Preview) | Shows the name of the AI agent platform whose agents use the service principal, such as Copilot Studio or Azure AI Foundry. To view the specific Copilot Studio agent connected to the Entra ID service principal, expand the OAuth app node in the [Graph tab](/defender-cloud-apps/app-governance-visibility-insights-view-apps#graph-tab). |
