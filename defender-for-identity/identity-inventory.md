...
The **Identity inventory** gives you a centralized view of all identities in your organization, so you can monitor and manage them efficiently. At a glance, you can see key details such as the identity's type, domain, tags, and other attributes, which help you quickly identify and manage identities that require attention.
