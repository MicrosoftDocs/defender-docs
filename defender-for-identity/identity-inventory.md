...
The **Non-Human identities** tab consolidates all non-human identities in one place, making it easier to check ownership and assess risk. To investigate details about a specific non-human identity, see [View a non-human identity](/defender-for-identity/investigate-non-human-identities).
...
| Name | Description |
| --------- | --------- |
| Risky | The number of non-human identities with an elevated risk score. Risk scores are based on factors described in the [Risk score tab of the identity](investigate-non-human-identities.md#risk-score). |
