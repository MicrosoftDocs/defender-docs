...
Defender for Identity sensor v3.x supports domain controllers that also run additional identity roles, including AD FS, AD CS, and Microsoft Entra Connect. 
