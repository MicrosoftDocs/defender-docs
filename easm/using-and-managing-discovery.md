---
title: Use and manage discovery in Microsoft Defender EASM
...
# Use and manage Defender EASM discovery
...
We recommend that you search for your organization's attack surface before you create a custom attack surface and run other discoveries. Searching for an existing attack surface first enables you to quickly access your inventory as Defender EASM refreshes the data and adds more assets and recent context to your attack surface.
...
![Screenshot of the Getting Started page where you select your organization from the list of preconfigured attack surfaces.](media/discovery-1.png)

After you select **Build my Attack Surface**, the discovery runs in the background. If you selected a preconfigured attack surface from the list of available organizations, you're redirected to the dashboard overview screen where you can view insights into your organization's infrastructure in Preview mode.
...
To create a discovery group, follow these steps:

1. On the leftmost pane, under **Manage**, select **Discovery**.

    ![Screenshot of the Defender EASM left navigation pane with the Discovery option highlighted under the Manage section.](media/discovery-2.png)
...
4. Select **Next: Seeds**.
    ...
    ![Screenshot of the discovery group setup page with fields for entering the group name, description, and recurring frequency.](media/discovery-4.png)
...
5. Select the seeds that you want to use for this discovery group. Seeds are known assets that belong to your organization. The Defender EASM platform scans these entities and maps their connections to other online infrastructure to create your attack surface. Since Defender EASM is intended to monitor your attack surface from an external perspective, private IP addresses cannot be included as discovery seeds. 
    ...
    ![Screenshot of the seed selection page where you choose known assets such as domains, hosts, and IP blocks to use as discovery seeds.](media/discovery-5.png)
    ...
    ![Screenshot of the Quick Start search results showing seeds populated from a preconfigured attack surface.](media/discovery-6.png)

    ![Screenshot of the Quick Start option showing the search field for selecting a preconfigured attack surface for your organization.](media/discovery-7.png)
