---
title: Create incidents from alerts in Microsoft Sentinel
description: Configure Microsoft Sentinel to automatically create incidents from alerts generated by connected Microsoft security solutions, with guidance on when this setup applies.
ms.author: guywild
author: guywi-ms
...
You can configure Microsoft Sentinel to automatically create incidents every time an alert is triggered in a connected Microsoft security solution, by following the instructions in this article.
