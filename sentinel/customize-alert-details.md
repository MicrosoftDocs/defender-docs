---
title: Customize alert details in Microsoft Sentinel
...
With the **alert details** feature, you can override the name, description, severity, tactics, and other default properties of alerts in two ways:
...
1. In the now-expanded **Alert details** section, add free text that includes properties corresponding to the details you want to display in the alert:
    ...
    1. To override more default properties, select **+ Add new** and repeat the previous step. The following properties can be overridden:
        ...
        | **ProductComponentName** (Preview)<br>\* If onboarded to Defender portal, this field is no longer available to customize. | String |
        | **ProductName** (Preview)<br>\* If onboarded to Defender portal, don't customize this field for Microsoft sources; doing so drops alerts from Defender XDR. | String |
        | **ProviderName** (Preview)<br>\* If onboarded to Defender portal, this field is no longer available to customize. | String |
...
The following limits apply when you customize alert details:
