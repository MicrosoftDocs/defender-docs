...
You can ingest data directly into the Microsoft Sentinel data lake without routing it through the analytics tier. This approach is useful when you want to store security data for long-term analysis without the associated analytics tier costs. For more information, see [Direct log ingestion to the Microsoft Sentinel data lake](sentinel-lake-log-ingestion-guidance.md).
