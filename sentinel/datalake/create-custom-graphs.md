...
:::image type="content" source="media/create-custom-graphs/edit-graph-job-details-placeholder.png" lightbox="media/create-custom-graphs/edit-graph-job-details-placeholder.png" alt-text="A screenshot placeholder showing the Edit graph job workflow in the Microsoft Sentinel Graph panel in Visual Studio Code.":::
...
1. Select **Create Scheduled Job** in the Sentinel notebook experience, then select **Create a graph job**. The **Create graph** form opens.
1. In the **Create graph** form, provide a graph name.
    ...
    - If you reuse an existing graph name, the existing tenant graph is overwritten after confirmation. Graph names are unique, so duplicate graph names aren't supported.
...
1. Optionally, update the **Schedule** information.
1. Optionally, update the **Description** field again as needed.
1. Select **Submit** to recreate the graph in your tenant.

:::image type="content" source="media/create-custom-graphs/overwrite-graph-job-placeholder.png" lightbox="media/create-custom-graphs/overwrite-graph-job-placeholder.png" alt-text="A screenshot placeholder showing the Create graph form used to overwrite an existing custom graph in Visual Studio Code.":::
