...
For more information on how AI is used within Microsoft Sentinel's unified MCP server, see [Application card: Microsoft Sentinel MCP server](sentinel-mcp-application-card.md).
