...
| Parameters | Required? | Description |
|---|---|---|
| `fileHash` |Yes |SHA-1 or SHA-256 hash of the file  |
...
| Parameters | Required? | Description |
|---|---|---|
| `fileHash` |Yes |SHA-1 or SHA-256 hash of the file. SHA-256 values are resolved to SHA-1 internally.  |

### Get file alerts (`GetDefenderFileAlerts`)  

List all security alerts generated by a specific file in your organization, including historical and active alerts.
