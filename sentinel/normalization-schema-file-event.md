---
title: The Advanced Security Information Model (ASIM) File Event normalization schema reference
...
| Field | Class | Type | Description |
|-------|-------|------|-------------|
| <a name="actingappname"></a>**ActingAppName** | Optional | String | The name of the acting application.<br><br>Example: `Facebook` |
