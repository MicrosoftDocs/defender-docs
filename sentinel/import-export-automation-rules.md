---
title: Import and export Microsoft Sentinel automation rules
...
- Learn more about [automation rules](automate-incident-handling-with-automation-rules.md) and [how to create and use automation rules](create-manage-use-automation-rules.md).
