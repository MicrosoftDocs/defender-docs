...
- If the associated data connector is installed and configured, select **Enable detection** to enable the detection rule.
    ...
    :::image type="content" source="./media/siem-migration/enable-detection.png" alt-text="Screenshot of the Enable detection button in the rule details side panel." lightbox="./media/siem-migration/enable-detection.png" lightbox-title="Enable detection":::
