...
1. Add **Conditions** to determine to which incidents new tasks will be added.
    ...
    Whether you select specific analytics rules or leave **All** selected, you can add more conditions to narrow the scope of incidents to which your automation rule will apply. Learn more about [adding advanced conditions to automation rules](add-advanced-conditions-to-automation-rules.md).
