---
title: Build and publish Microsoft Sentinel solutions
description: Learn how partners can build and publish Microsoft Sentinel solutions for the Microsoft Security Store or Content Hub, including solution components such as connectors, notebooks, and agents.
...
|**Review the docs**|There is a rich collection of documentation to support with your journey. Here are some key resources to get you started. <br><br> For more information, see:<br> [Microsoft Sentinel solutions repository on GitHub](https://github.com/Azure/Azure-Sentinel/tree/master/Solutions) <br>[Advanced Security Information Model (ASIM) schema](/azure/sentinel/normalization-content) <br>[Get started with Kusto Query Language](/archive/blogs/msdn/ben/getting-started-with-the-kusto-query-language)|
|**Become a Cloud Partner and create a Publisher Account**|Microsoft Sentinel solutions are published on the Azure Commercial Marketplace. To publish to the marketplace, join the cloud partner program. <br><br> For more information, see:<br> [Microsoft commercial marketplace overview](/partner-center/marketplace-offers/overview) <br>[Create a commercial marketplace account in Partner Center](/partner-center/account-settings/create-account) <br>[Join ISV Success program](https://www.microsoft.com/isv/offer-benefits) <br>[Sign up for Microsoft for Startups program, if applicable](https://www.microsoft.com/startups)|
...
<a name="publish"></a>
## Publish your Microsoft Sentinel solution
...
<a name="preview"></a>
## Preview your solution before publishing
