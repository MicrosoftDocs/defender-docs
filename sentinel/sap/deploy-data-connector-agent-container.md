...
| **collect-user-master-data** | Determines whether User Master data is ingested or not to the tables `ABAPAuthorizationDetails` and `ABAPUserDetails`. | **true**: Ingested<br>**false**: Not ingested | **true** |
