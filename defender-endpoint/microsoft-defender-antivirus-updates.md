---
title: Microsoft Defender Antivirus security intelligence and product updates and support
...
#customer intent: As an IT admin, I want to understand Microsoft Defender Antivirus update types and support phases so that I can keep my devices protected and plan update rollouts.
---
...
[Cloud-delivered protection](cloud-protection-microsoft-defender-antivirus.md) is always on and requires an active connection to the internet. Security intelligence updates occur on a scheduled cadence that you can configure using a policy.

## Product updates

Microsoft Defender Antivirus requires monthly updates (KB4052623) known as _platform updates_.

You can manage the distribution of updates using one of the following methods:

- [Windows Server Update Service (WSUS)](/windows-server/administration/windows-server-update-services/get-started/windows-server-update-services-wsus)
...
<a name="platform-and-engine-releases"></a>
...
- [MpCmdRun command-line utility](command-line-arguments-microsoft-defender-antivirus.md):
