...
<!-- Placeholder > Removing this outdated video. Seeking possiblyh replacemen.
...
To see how many of your Intune-managed devices are onboarded, open the [Microsoft Defender portal](https://security.microsoft.com) and go to **Endpoints** > **Configuration management** > **Dashboard**. The **Onboarded devices** card gives you a high-level view of your onboarding rate, comparing the number of Windows devices that are onboarded to Defender for Endpoint against the total number of Intune-managed Windows devices.
