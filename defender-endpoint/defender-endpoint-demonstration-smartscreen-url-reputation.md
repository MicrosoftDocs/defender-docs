...
- Server devices must be running Windows server 2016 and later, Windows Server 2012 R2, Windows Server 2008 R2 SP1 or Azure Stack HCI OS, version 23H2 and later.
