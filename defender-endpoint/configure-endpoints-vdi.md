...
> [!NOTE]
> Windows Server 2016 and Windows Server 2012 R2 must be prepared by applying the installation package first using the instructions in [Onboard Windows servers](configure-server-endpoints#windows-server-2012-r2-and-windows-server-2016.md) for this feature to work.
