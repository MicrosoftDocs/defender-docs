...
4. Depending on the method you'd like to implement, follow the appropriate steps:
   ...
   > The script `Onboard-NonPersistentMachine.ps1` is not signed and administrators will need to use an approved method to run this in a restricted enviorment if PowerShell's execution policy is restricted. Example "-ExecutionPolicy Bypass" 
