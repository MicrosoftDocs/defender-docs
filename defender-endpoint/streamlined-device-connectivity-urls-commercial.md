...
|Core Defender for Endpoint services|443|https://config.edge.skype.com/config/v1|Used for internal configuration management|Required|This URL is used for internal configuration management.|Linux|
