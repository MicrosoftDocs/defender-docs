...
|Defender for Endpoint|443|https://config.edge.skype.com/config/v1|Internal configuration management|Required|This URL is used for internal configuration management.|Linux|
