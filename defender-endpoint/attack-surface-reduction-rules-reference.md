...
| [Block Webshell creation for Servers](#block-webshell-creation-for-servers)  | N | Y <br>Exchange role only  | Y on Windows Server 2016, N on Windows Server 2012 R2 <br>Exchange role only |
