...
[Manage alerts](/defender-xdr/investigate-alerts#manage-alerts?toc=/defender-endpoint/toc.json&bc=/defender-endpoint/breadcrumb/toc.json)|Learn about how you can manage alerts such as change its status, assign it to a security operations member, and see the history of an alert.
