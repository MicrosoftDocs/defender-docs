...
|Microsoft Defender for Endpoint|GCC|Microsoft Defender for Endpoint GCC|443|us4-v20.events.data.microsoft.com|Microsoft Defender for Endpoint EDR Cyber Data |Required|Yes|Yes|
...
|Microsoft Defender for Endpoint|DoD|Microsoft Defender for Endpoint DoD|443|automatedirstrffusgv.blob.core.usgovcloudapi.net|Microsoft Defender for Endpoint AutoIR Sample Storage|Required|Yes|
...
|Microsoft Defender for Endpoint|DoD|Microsoft Defender for Endpoint DoD|443|ussusd2centralff5.blob.core.usgovcloudapi.net|Malware Sample Submission Storage|Required|Yes|Yes|Yes|
...
|Microsoft Defender Antivirus|US Gov|MU (ADL)|443|*.download.windowsupdate.com|ADL - Alternate location for Microsoft Defender Antivirus Security intelligence updates|Optional|Yes|Yes|	Yes|
