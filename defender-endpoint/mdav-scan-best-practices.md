...
> [!NOTE]
> If real-time protection is turned on, files are scanned before they are accessed and executed. Scan occurs regardless where the files are located (see Configure scanning options for Microsoft Defender Antivirus | Microsoft Learn).
...
To configure scanning options for Microsoft Defender Antivirus, you can use various tools (see Configure scanning options for Microsoft Defender Antivirus | Microsoft Learn). Here are some of the available settings and switches that you can use to configure Microsoft Defender Antivirus full scans:
...
Note 1: See the idle state criteria here Task idle conditions - Win32 apps | Microsoft Learn
