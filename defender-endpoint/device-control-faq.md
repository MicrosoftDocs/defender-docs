...
1. Locate the media in Device Manager (for example, under Disk drives), right-click on the media, and then select **Properties**

   :::image type="content" source="media/device-manager-select-media.png" alt-text="Screenshot of right-clicking on the media in Device Manager and then selecting Properties." lightbox="media/device-manager-select-media.png":::

1. In the properties of the media, select the **Details** tab, and then select the **Device instance path** property.

   :::image type="content" source="media/device-manager-media-properties.png" alt-text="Screenshot of the Device instance path property of the Details tab of the media properties in Device Manager." lightbox="media/device-manager-media-properties.png":::
...
:::image type="content" source="media/microsoft-entra-group-sid.png" alt-text="Screenshot of the Object ID value in the group properties in the Microsoft Entra admin center." lightbox="media/microsoft-entra-group-sid.png":::
...
1. Read access to some WD My Passport USBs requires Disk level Write access. To deny Write access, you use the **File system level access**.
