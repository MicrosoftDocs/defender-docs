...
| Feature | Description |
|---|---|
| [Next-generation protection](next-generation-protection.md) | Antivirus and antimalware protection by using behavior-based, cloud-delivered, and machine-learning techniques. |
