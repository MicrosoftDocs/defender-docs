...
When using Windows Enterprise multi-session, per our security best practices the virtual machine (VM) can be licensed through Microsoft Defender for Servers or you can choose to have all Azure Virtual Desktop VM users licensed through one of the following licenses:
