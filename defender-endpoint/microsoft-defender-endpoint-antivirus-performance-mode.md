...
1. Double-click **Configure performance mode status**.
...
1. Select **Enabled**.
    ...
    :::image type="content" source="media/microsoft-defender-endpoint-antivirus-performance-mode/defender-performance-mode-11.png" alt-text="Screenshot of Defender Performance Mode 11.":::
...
1. Type `set-MpPreference -PerformanceModeStatus Enabled` and press **Enter**.
    ...
    :::image type="content" source="media/microsoft-defender-endpoint-antivirus-performance-mode/defender-performance-mode-5.png" alt-text="Screenshot of Defender Performance Mode 04.":::
