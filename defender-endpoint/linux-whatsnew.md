...
- Agent process handling has been streamlined by removing the dedicated telemetryd_v2 process, resulting in more efficient and consistent telemetry collection. This change applies to builds 101.24062.0001 and later. There is no impact on existing functionality, data collection behavior, or customer configurations. All features and capabilities remain fully intact, and no action is required from customers.
