...
|Service|Geography|Category|Port|Endpoint/URL|Endpoint/URL Description|Required / Optional|Windows 10, 11 / Server 2022, 2019, 2016 (Unified Agent) / Server 2012 R2 (Unified Agent) |Windows 7, 8.1|Windows Server 2008 R2, 2012 R2, 2016 (MMA Based)|Mac|Linux|Comments|
|-|-|-|-|-|-|-|-|-|-|-|-|
