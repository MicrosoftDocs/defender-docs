...
|Microsoft Defender for Endpoint|WW|Common (Mac/Linux)|443|`res.public.onecdn.static.microsoft`|Microsoft Office Content Delivery Network (CDN) - Product Updates|Required||||Yes|Yes|New CDN endpoint starting with macOS build 101.26012.0012|
