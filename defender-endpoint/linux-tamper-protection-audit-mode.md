...
- Defender for Endpoint version `101.26071*` or later from the Insiders-Slow ring.
...
During public preview, tamper protection in audit mode is enabled by default. No manual configuration is required.
...
:::image type="content" source="media/linux-tamper-protection-audit-mode/tamper-protection-device-timeline.png" alt-text="Screenshot of a device timeline in the Microsoft Defender portal showing a Microsoft Defender for Endpoint tampering alert." lightbox="media/linux-tamper-protection-audit-mode/tamper-protection-device-timeline.png":::

:::image type="content" source="media/linux-tamper-protection-audit-mode/tamper-protection-incidents-alerts.png" alt-text="Screenshot of the Incidents and alerts tab for a Linux device in the Microsoft Defender portal showing tampering alerts." lightbox="media/linux-tamper-protection-audit-mode/tamper-protection-incidents-alerts.png":::

Open a tampering alert to review more information about the activity, including the process tree and alert timeline.

:::image type="content" source="media/linux-tamper-protection-audit-mode/tamper-protection-alert-details.png" alt-text="Screenshot of a Microsoft Defender for Endpoint tampering alert showing the process tree and alert timeline in the Microsoft Defender portal." lightbox="media/linux-tamper-protection-audit-mode/tamper-protection-alert-details.png":::
