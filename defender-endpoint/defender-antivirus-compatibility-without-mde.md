...
|Windows server 2016 and later, Windows Server version 1803 or newer, and Azure Stack HCI OS version 23H2 and later.|Microsoft Defender Antivirus|Active mode|
|Windows server 2016 and later, Windows Server version 1803 or newer, and Azure Stack HCI OS version 23H2 and later.|A non-Microsoft antivirus solution|Disabled (set manually; see the note that follows this table)|
