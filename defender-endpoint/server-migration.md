...
4. Install the Defender for Endpoint package for Windows Server 2012 R2 and Windows Server 2016, and set it to passive mode. See [Onboard Windows Server 2012 R2 and Windows Server 2016 to Microsoft Defender for Endpoint](onboard-server.md#onboard-windows-server-2012-r2-and-windows-server-2016-to-microsoft-defender-for-endpoint).
