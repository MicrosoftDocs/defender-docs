...
|Allow these URLs from [version 2512](../microsoft-defender-endpoint-releases#linux--february-2026--101251220004) and later. These URLs are used for internal configuration management.<br><br>- Default: `https://config.edge.skype.com/config/v1`<br>- DoD: `https://config.ecs.dod.teams.microsoft.us/config/v1`<br>- GCC High: `https://config.ecs.gov.teams.microsoft.us/config/v1`<br>- GCC Mod: `https://gccmod.ecs.office.com/config/v1` | N/A |
