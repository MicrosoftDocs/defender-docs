...
| **Device protection** | Allows [automated investigation and response (AIR)](../respond-machine-alerts.md#initiate-automated-investigation) to be performed on the device. | This applies to both automatically triggered AIR and manually initiated AIR. |