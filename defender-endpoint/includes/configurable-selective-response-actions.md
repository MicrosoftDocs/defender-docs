...
| **Advanced response** | [Isolate device](../respond-machine-alerts.md#isolate-devices-from-the-network), [restrict app execution](../respond-machine-alerts.md#restrict-app-execution), and [request remediation](../../defender-vulnerability-management/tvm-remediation.md#request-remediation). | *Request remediation* allows security administrators to initiate remediation actions for identified vulnerabilities on a specific device. |
