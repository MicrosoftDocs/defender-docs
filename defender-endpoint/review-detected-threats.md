...
You can manage threat detections for any devices that are [enrolled in Microsoft Intune](/intune/intune-service/enrollment/windows-enrollment-methods) using the following steps:
