...
6. The security team [creates a rule](/defender-xdr/custom-detection-rules#2-create-new-rule-and-provide-alert-details) to detect suspicious commands, specifying the action, `Restrict app execution`. Suspicious commands could include: 
