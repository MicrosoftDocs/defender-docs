...
In an Intune policy and in [Defender for Endpoint Security Settings Management](/intune/intune-service/protect/mde-security-integration), you can configure two scanning schedules:
