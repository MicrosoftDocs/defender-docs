...
In an Intune policy and in [Defender for Endpoint Security Settings Management](/mem/intune/protect/mde-security-integration), you can configure two scanning schedules:
