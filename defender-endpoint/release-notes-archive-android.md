---
title: Archive of past updates for Microsoft Defender for Enpoint on Android  
description: This article is an archive that describes updates made in past releases of Defender for Endpoint on Android devices.
...
# Archive of past updates for Microsoft Defender for Enpoint on Android

This article is an archive that describes updates made in past releases of Defender for Endpoint on Android devices. To see the latest what's new list, see [What's new in Microsoft Defender for Endpoint on Android](./android-whatsnew.md).
