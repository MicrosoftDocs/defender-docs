...
| 2. Configure your antivirus scans. | You can schedule automatic antivirus scans by using either Anacron or Crontab. <br/><br/>See the following articles: <br/>- [Use Anacron to schedule an antivirus scan in Microsoft Defender for Endpoint on Linux](mde-linux-antivirus-scan-anacron.md)<br/>- [Use Crontab to schedule an antivirus scan in Microsoft Defender for Endpoint on Linux](mde-linux-antivirus-scan-crontab.md) | 
