...
|Microsoft Defender SmartScreen|DoD|Used for internal configuration|443|https://config.ecs.dod.teams.microsoft.us/config/v1|This URL is used for internal configuration|Required|||||Yes|
|Microsoft Defender SmartScreen|GCC High|Used for internal configuration|443|https://config.ecs.gov.teams.microsoft.us/config/v1|This URL is used for internal configuration|Required|||||Yes|
|Microsoft Defender SmartScreen|GCC Mod|Used for internal configuration|443|https://gccmod.ecs.office.com/config/v1|This URL is used for internal configuration|Required|||||Yes|
