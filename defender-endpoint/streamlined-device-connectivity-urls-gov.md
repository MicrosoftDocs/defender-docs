...
|Microsoft Defender for Endpoint|DoD|Internal configuration|443|https://config.ecs.dod.teams.microsoft.us/config/v1|This URL is used for internal configuration|Required|||||Yes|
|Microsoft Defender for Endpoint|GCC High|Internal configuration|443|https://config.ecs.gov.teams.microsoft.us/config/v1|This URL is used for internal configuration|Required|||||Yes|
|Microsoft Defender for Endpoint|GCC Mod|Internal configuration|443|https://gccmod.ecs.office.com/config/v1|This URL is used for internal configuration|Required|||||Yes|
