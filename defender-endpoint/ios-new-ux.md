...
1. **Web Protection**
    ...
    :::image type="content" source="media/mde-ios-web-protection-rec-card.png" alt-text="Image showing the web protection  recommendation card feature on the MDE iOS app" lightbox="media/mde-ios-web-protection-rec-card.png":::

2. **Device Health (iOS Update)**

    :::image type="content" source="media/mde-ios-device-health-rec-card.png" alt-text="Image showing the device health recommendation card feature on the MDE iOS app" lightbox="media/mde-ios-device-health-rec-card.png":::