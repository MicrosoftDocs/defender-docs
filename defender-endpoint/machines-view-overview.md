...
**Transient devices** | By default transient devices are filtered out of the device inventory to reduce inventory noise. You can turn transient device filtering off using the *Transit device* tag. Learn more about [transit device filtering](transient-device-tagging.md).
