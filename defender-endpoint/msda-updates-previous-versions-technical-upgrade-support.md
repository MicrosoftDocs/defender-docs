...
- Fixed an issue with [ASR rules deployed via Intune](attack-surface-reduction-rules-enable.md#configure-asr-rules-in-microsoft-intune) to display accurately in the Microsoft Defender portal
