...
- Improved error reporting in the [modern, unified agent installer](configure-server-endpoints.md#windows-server-2016-functionality-in-the-modern-unified-solution)
