...
#customer intent: As an IT admin, I want to understand MpCmdRun command-line switches so that I can automate and troubleshoot Microsoft Defender Antivirus tasks.
---
...
|---|---|
|**ValidateMapsConnection failed (800106BA)** or **0x800106BA**|The Microsoft Defender Antivirus service is disabled. Enable the service and try again. If you need help re-enabling Microsoft Defender Antivirus, see [Reinstall/enable Microsoft Defender Antivirus on your endpoints](switch-to-mde-phase-2.md#step-1-reinstallenable-microsoft-defender-antivirus-on-your-endpoints). <br/><br/> In Windows 10 version 1909 (November 2019) or earlier and Windows Server 2019 or earlier, the service was formerly named _Windows Defender Antivirus_.|
|**0x80070667**|You ran the `MpCmdRun.exe -ValidateMapsConnection` command on an unsupported version of Windows. Run the command on supported versions of Windows: <ul><li>Windows 10 version 1703 (April 2017) or later.</li><li>Windows Server 2019 or later.</li></ul>|
