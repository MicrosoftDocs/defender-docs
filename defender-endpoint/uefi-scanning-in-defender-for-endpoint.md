...
- Devices are running a current [Microsoft Defender Antivirus platform version](microsoft-defender-endpoint-versions.md#microsoft-defender-antivirus-versions)
