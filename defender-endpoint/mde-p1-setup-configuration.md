...
| Operating systems (server) | Windows Server 2025, Azure Stack HCI OC version 23H2 and later. <br/>Windows Server 2022<br/>Windows Server 2019<br/>Windows Server version 1803 and later<br/>Windows Server 2016 and 2012 R2 are supported when using the [modern unified solution](onboard-server.md#functionality-in-the-modern-unified-solution-for-windows-server-2016-and-windows-server-2012-r2)<br/>[Linux](microsoft-defender-endpoint-linux.md)   |
