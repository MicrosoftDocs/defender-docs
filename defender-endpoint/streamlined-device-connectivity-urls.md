...
|--------------------------------------------|-----------|-----------------------------------|------|------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| Consolidated Defender for Endpoint services| WW        | Streamlined connectivity new URL  | 443  | *.endpoint.security.microsoft.us                     | Used for streamlined connectivity URL consolidation and future services                            |
| Microsoft Defender SmartScreen             | GCC       | Reporting and Notifications       | 443  | unitedstates4.ss.wd.microsoft.us                     | SmartScreen protection, reporting, notifications, MDAV Network Protection, custom URL indicators  |
