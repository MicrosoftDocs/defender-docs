...
- Server devices must be running Windows Server 2016 and later, Windows Server 2012 R2 with the [Functionality in the modern unified solution](onboard-server.md#functionality-in-the-modern-unified-solution-for-windows-server-2016-and-windows-server-2012-r2)
- The [Block or allow feature is turned on](advanced-features.md) or Azure Stack HCI OS version 23H2 and later.
...
- Devices are running either:
    ...
    - Windows Server 2012 R2 or Windows Server 2016 with the [modern unified solution](onboard-server.md#functionality-in-the-modern-unified-solution-for-windows-server-2016-and-windows-server-2012-r2)
