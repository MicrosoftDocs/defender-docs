...
|---------|------------|-------------|-------------|
|Feature |[Selective Response Actions](restrict-response-actions-on-high-value-assets.md) |Preview |Selective Response Actions enables organizations to tailor high-impact security operations on devices during onboarding. It provides precise control over how response actions are applied on Tier-0 systems and other high-value assets, helping maintain operational stability while delivering strong protection. To learn more about this feature, see Restrict response actions on high-value assets. |
