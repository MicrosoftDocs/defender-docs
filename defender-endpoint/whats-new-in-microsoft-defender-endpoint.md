...
|---------|------------|-------------|-------------|
|Feature |New Microsoft Secure Score recommendation |Preview |Microsoft Secure Score now includes a new recommendation to help organizations assess readiness for the Secure Boot 2023 certificate transition: <br> - **Ensure devices are updated to Secure Boot 2023 certificates and boot manager:** Helps identify devices that have not yet transitioned to the new Secure Boot 2023 certificates required ahead of the June 2026 expiration. Devices that remain on older Secure Boot certificates will no longer be able to receive new security protections for the early boot process. This recommendation provides centralized visibility into deployment status across the environment, enabling organizations to identify exposure, prioritize remediation, and track rollout progress at scale. |
