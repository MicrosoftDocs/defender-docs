...
|---------|------------|-------------|-------------|
|Feature |[Exposure score transition in Defender Vulnerability Management (Preview)](/defender-vulnerability-management/exposure-score-transition) |Preview |The new exposure score model in Defender Vulnerability Management is now available in preview. This model improves risk prioritization and recommendation impact accuracy by incorporating exploit prediction data (EPSS) and asset context factors such as internet-facing status and criticality. |
