...
- (GA) [Microsoft Defender for Endpoint plug-in for Windows Subsystem for Linux (WSL)](https://learn.microsoft.com/en-us/defender-endpoint/mde-plugin-wsl) is now generally available. The plug-in enables Defender for Endpoint to provide more visibility into all running WSL containers by plugging into the isolated subsystem.
