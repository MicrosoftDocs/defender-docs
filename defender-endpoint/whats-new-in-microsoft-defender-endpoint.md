...
|Platform  |Preview/GA  |Updates  |
|---------|------------|---------|
| **Windows** | GA | - [Aggregated reporting in Microsoft Defender for Endpoint](aggregated-reporting.md): Aggregated reporting is now generally available. |
