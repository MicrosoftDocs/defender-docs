...
|---------|---------|
| Microsoft Defender for Endpoint Streamlined Connectivity URL list for Gov/GCC/DoD | Spreadsheet of consolidated URLs for service locations, geographic locations, and OS for Gov/GCC/DoD customers. <br/><br/> [Download the spreadsheet here.](https://aka.ms/MDE-streamlined-gov-urls) |
