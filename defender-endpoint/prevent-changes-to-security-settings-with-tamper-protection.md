...
This article describes tamper protection in Microsoft Defender for Endpoint, how it safeguards security settings from being disabled or changed, and how to configure and manage it for your organization.
...
Use the following steps to check whether tamper protection and real-time protection are enabled on a device:
...
Whenever a tampering attempt is detected, an alert is raised in the [Microsoft Defender portal](/defender-xdr/microsoft-365-security-center-mde) ([security.microsoft.com](https://security.microsoft.com)).
