...
|[Defender for Endpoint Plan 1](defender-endpoint-plan-1.md)|Linux  (see [System requirements](/defender-endpoint/mde-linux-prerequisites))|[Defender for Endpoint on Linux: Network connections](mde-linux-prerequisites.md#network-connections)|
