...
Once you turn on the Microsoft Defender for Cloud Apps integration, Microsoft Defender for Endpoint immediately starts forwarding discovery signals to Defender for Cloud Apps.
