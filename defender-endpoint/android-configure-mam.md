...
4. Install the Microsoft Defender: Antivirus (Mobile) app and go back to the managed app onboarding screen.
    ...
    :::image type="content" source="media/android-configure-mam/mam-flow.png" alt-text="The shows the pages that contain the procedure of downloading Microsoft Defender: Antivirus (Mobile) app." lightbox="media/android-configure-mam/mam-flow.png":::
