...
<<<<<<< HEAD
   :::image type="content" source="media/internet-facing-filter.png" alt-text="Screenshot of the internet-facing filter" lightbox="media/internet-facing-filter.png":::
...
>>>>>>> parent of 65ddbc8b8d (Update internet-facing-devices.md)
