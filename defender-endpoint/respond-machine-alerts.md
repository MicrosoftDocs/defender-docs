...
- Full isolation is available for devices running Windows 11, Windows 10, version 1703 or later, Windows Server 2016 and later, Windows Server 2012 R2, and Azure Stack HCI OS version 23H2 and later.
...
- Selective isolation is available for devices running on Windows 11, Windows 10 version 1703 or later, Windows Server 2016 and later, Azure Stack HCI OS version 23H2 and later or Windows Server 2012 R2, and macOS. For more information about selective isolation, see [Isolation exclusions](./isolation-exclusions.md).
