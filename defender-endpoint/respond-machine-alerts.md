...
To view the current status of the GPO hardening action and other actions, see [Track the action status in the Activities tab](/defender-xdr/autoad-results#track-the-action-status-in-the-activities-tab).
