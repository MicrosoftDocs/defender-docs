...
1. Wait until installation is complete, and then select **OK**. No device reboot is required.
   ...
   :::image type="content" source="./media/defender-deployment-tool-windows/onboarding-completed-message.png" alt-text="Screenshot showing the message indicating that onboarding is complete.":::
