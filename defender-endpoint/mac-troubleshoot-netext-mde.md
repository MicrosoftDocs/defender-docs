...
1. In your [JamF portal](https://jamfcloud.com), select **Computers**, and then select **Static device groups**.
...
1. In your [JamF portal](https://jamfcloud.com), select **Computers**, and then select **Configuration Profiles**.
