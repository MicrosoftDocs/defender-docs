...
> [!NOTE]
> Checking exclusions with `MpCmdRun` requires Microsoft Defender Antivirus [version 4.18.2111-5.0 (released in December 2021)](msda-updates-previous-versions-technical-upgrade-support#november-2021-platform-41821115--engine-11188004.md) or later.
