...
- Windows server devices must be running Windows Server 2016 and later, Azure Stack HCI OS version 23H2 and later, or Windows Server 2012 R2 (with the [Functionality in the modern unified solution](onboard-server.md#functionality-in-the-modern-unified-solution-for-windows-server-2016-and-windows-server-2012-r2)).
