...
description: Describes how to conduct prerelease tests before mainstream release using Google Play preproduction tracks
...
ms.date: 04/14/2025
#customer intent: As an IT admin, I want to test custom APKs using Google Play preproduction tracks so that I can ensure the app is working as expected before deploying it to users.
---
...
Learn how to deploy custom .APK files or conduct prerelease app tests using Google Play preproduction tracks. This is useful for testing custom .APK before deploying them to users in your organization. The preproduction track allows you to test the app with a limited number of users before making it available to everyone.
...
To deploy custom .APK files in the Android Enterprise scenario, follow these steps:

1. Contact Microsoft Support to provide the Google Play Store Organization ID for your organization. This ID is required to add your information to an inclusion list and make the preproduction build available for testing.
