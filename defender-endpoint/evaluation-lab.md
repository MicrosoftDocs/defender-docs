...
1. In the navigation pane, select **Evaluation & tutorials** \> **Evaluation lab**, then select **Setup lab**.
   ...
   :::image type="content" source="/defender/media/evaluationtutormenu.png" alt-text="The evaluation lab welcome page" lightbox="/defender/media/evaluationtutormenu.png":::
...
2. Choose the type of device to add. You can choose to add Windows 10, Windows 11, Windows Server 2019, Windows Server 2016, and Linux (Ubuntu).
   ...
   :::image type="content" source="/defender/media/add-machine-optionsnew.png" alt-text="The lab setup with device options" lightbox="/defender/media/add-machine-optionsnew.png":::
...
3. The connection details are displayed. Select **Copy** to save the password for the device.
   ...
   > The password is only displayed once. Be sure to save it for later use.
    ...
    :::image type="content" source="/defender/media/add-machine-eval-lab-new.png" alt-text="The device added with connection details" lightbox="/defender/media/add-machine-eval-lab-new.png":::
