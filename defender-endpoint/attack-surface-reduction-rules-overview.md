...
1. Select the file *cfa-events.xml* from where it was extracted. Alternatively, [copy the XML directly](attack-surface-reduction-windows-events.md#copy-the-xml-directly).
