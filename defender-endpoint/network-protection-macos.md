...
5. On the **Configuration settings** tab, select **Add settings**. In the **Settings picker** flyout that opens, scroll down and select **Microsoft Defender** \> **Network protection**. In the settings list that appears, select **Enforcement level**, and then close the **Settings picker** flyout.
...
8. On the **Review + create** tab, verify the settings, and then select **Create**.
