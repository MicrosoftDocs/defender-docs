...
> [!NOTE]
> Apple only supports 1 bundle ID, in this case 'settings preferences' profile; thus, you can either set the policies from the Microsoft Defender for Endpoint Security Settings management or via Intune or via JamF or via another third-party MDM product.

You can configure anti-malware and EDR policies through the following method:
