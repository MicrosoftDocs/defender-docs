...
|---|:---:|:---:|:---:|:---:|
|**Prevention**|||||
|[Attack surface reduction (ASR) rules](attack-surface-reduction-rules-overview.md)|![Yes.](media/svg/check-yes.svg)|![Yes.](media/svg/check-yes.svg)|![No](media/svg/check-no.svg)|![No](media/svg/check-no.svg)|
...
> - For Windows 7 SP1 and Windows Server 2008 R2 SP1, you can also use [Microsoft Defender endpoint security solution](./onboard-downlevel.md#use-the-defender-deployment-tool-to-deploy-defender-endpoint-security) supplied by the [Defender deployment tool](./defender-deployment-tool-windows.md).
