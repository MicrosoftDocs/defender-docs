...
To help protect your network and devices, Microsoft Defender for Business includes several attack surface reduction capabilities, including _attack surface reduction (ASR) rules_ as described in the following table:
...
|**[Firewall protection](mdb-firewall.md)**|Determines the network traffic permitted to flow to or from your organization's devices.|
...
|**[Web protection](/defender-endpoint/web-protection-overview)**|Integrates with web browsers and works with network protection to protect against web threats and unwanted content. Web protection includes web content filtering and web threat reports.|
