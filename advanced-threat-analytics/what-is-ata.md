...
> **Support Lifecycle**
>
> Extended support for ATA ended in January 2026. To stay supported and benefit from enhanced identity security capabilities, migrate to [Microsoft Defender for Identity](../defender-for-identity/index.yml). Note the licensing differences between the products.
