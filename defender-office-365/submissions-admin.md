...
> - If you have allowed atleast 7 email addresses from a particular domain inside Tenant Allow/Block List, submissions will automatically rollup the email addresses into a domain allow entry. This happens when submission is trying to add an email address allow for that domain. 
