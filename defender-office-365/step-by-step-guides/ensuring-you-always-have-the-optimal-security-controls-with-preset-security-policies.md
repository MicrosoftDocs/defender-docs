...
1. Select **All Recipients** to apply default email protections in Microsoft 365 tenant wide, or select **Specific recipients** to manually add users, groups, or domains you want to apply the protection policy to. Click the **Next** button.
