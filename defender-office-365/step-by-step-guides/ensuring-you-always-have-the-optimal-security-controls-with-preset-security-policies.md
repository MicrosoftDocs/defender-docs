...
1. Select **All Recipients** to apply the built-in security features for all cloud mailboxes to all recipients in the organization, or select **Specific recipients** to manually add users, groups, or domains you want to apply the preset security policy to. Click the **Next** button.
