...
> [!TIP]
> For more detailed information on what you've learned so far, see [Configure spam filter policies - Office 365](../anti-spam-policies-configure.md)| [Configure anti-phishing policies in Microsoft 365](../anti-phishing-policies-eop-configure.md) | [Configure anti-malware policies](../anti-malware-policies-configure.md)| [Set up Safe Attachments policies in Microsoft Defender for Office 365](../safe-attachments-policies-configure.md)
