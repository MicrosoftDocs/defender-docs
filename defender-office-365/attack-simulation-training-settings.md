...
If you go directly to the **Simulations** tab and manually toggle **Show excluded simulations** on :::image type="icon" source="/defender/media/scc-toggle-on.png" border="false":::, _only_ excluded simulations are shown.
