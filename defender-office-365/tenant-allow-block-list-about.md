...
## Allow entries in the Tenant Allow/Block List
 ...
 Unnecessary allow entries expose your organization to malicious email that could have been filtered by the system.

- **Domains and email addresses** and **URLs**: You can create allow entries directly in the Tenant Allow/Block List. These allows will override spam (including bulk) and low confidence phishing verdicts. For malware and high confidence phish verdict, you use the **Submissions** page at <https://security.microsoft.com/reportsubmission> to submit the **[email](submissions-admin.md#report-good-email-to-microsoft)**,  or **[URL](submissions-admin.md#report-good-urls-to-microsoft)** to Microsoft. After you select **I've confirmed it's clean**, you can then select **Allow this message**, or **Allow this URL** to create an allow entry for the domains and email addresses, or URLs.

- **Files**: You can't create allow entries directly in the Tenant Allow/Block List. Instead you use the **Submissions** page at <https://security.microsoft.com/reportsubmission> to submit the **[email attachment](submissions-admin.md#report-good-email-attachments-to-microsoft)** to Microsoft. After you select **I've confirmed it's clean**, you can then select **Allow this file** to create an allow entry for the files.
