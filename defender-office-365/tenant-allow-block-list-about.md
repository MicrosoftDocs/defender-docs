...
The Tenant Allow/Block List domains & addresses, spoofed senders apply to internal messages sent within the organization. Block entries for **Domains and email addresses** also prevent users in the organization from *sending* email to those blocked domains and addresses.
