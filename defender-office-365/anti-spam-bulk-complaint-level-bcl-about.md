...
- The **Bulk moves enabled** setting is turned on in anti-spam policies.

If the user meets these requirements, bulk mail that would normally be delivered to the Inbox is delivered to the **Promotions** folder instead.
