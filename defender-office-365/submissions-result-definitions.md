...
>
> - AI-powered Submissions Response provides generative AI explanations for admin and user reported email submissions to Microsoft. These explanations provide enterprise admins with clear, detailed, human-readable explanations for why messages were classified. Currently, this feature is scoped to email submissions only, and AI-generated explanations aren't used for the following types of submissions:
>   - Files
>   - URLs
...
|Completed|Authentication failed|The message wasn't delivered because it failed email authentication. If you own this domain, review your domain authentication settings. Otherwise, contact the domain owner. For more information, see [Email authentication](email-authentication-about.md).|
|Completed|Spoofed message|The submitted item was sent by someone who is spoofing the sender. For more information, see [Spoof intelligence insight](anti-spoofing-spoof-intelligence.md).|
