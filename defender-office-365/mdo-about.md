...
Although all organizations with cloud mailboxes include Baseline Email Protection, Microsoft Defender for Office 365 is the primary email and collaboration security solution for Microsoft 365.

This article explains the _protection ladder_ for email and collaboration. The ladder starts with Baseline Email Protection for cloud mailboxes, and continues to Defender for Office 365 Plan 1 and Defender for Office 365 Plan 2.
...
1. **Baseline Email Protection**: Included in all Microsoft 365 subscriptions with cloud mailboxes.
...
- **Baseline Email Protection** prevent broad, volume-based, known email attacks.
...
### Baseline Email Protection capabilities

Baseline Email Protection capabilities included in all organizations with cloud mailboxes are summarized in the following table:
...
For more information, see [Baseline Email Protection for cloud mailboxes](eop-about.md).
...
The extra features you get in **Defender for Office 365 Plan 1** on top of Baseline Email Protection are described in the following table:
...
This quick-reference section summarizes the different capabilities between Defender for Office 365 Plan 1 and Plan 2 that aren't included in Baseline Email Protection.
