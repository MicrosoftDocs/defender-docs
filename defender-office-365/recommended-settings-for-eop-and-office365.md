...
> |**Bulk moves enabled** (currently in Preview) (_BulkMovesEnabled_)|<details><summary>Show details</summary><br>**Default**: **Off** (`NotSet`)<br>**Standard**: **Off** (`NotSet`)<br>**Strict**: **Off** (`NotSet`)<br>**Comment**: For more information, see zzz.</details>|
