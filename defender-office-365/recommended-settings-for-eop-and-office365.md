...
> |**From these countries** (_EnableRegionBlockList_ and _RegionBlockList_)|<details><summary>Show details</summary><br>**Default**: **Off** (`$false` and Blank)<br>**Standard**: **Off** (`$false` and Blank)<br>**Strict**: **Off** (`$false` and Blank)<br>**Comment**: We have no specific recommendation for this setting. You can block messages from specific countries/regions based on your business needs.</details>|
