...
> |**Bulk moves enabled** (currently in Preview) (_BulkMovesEnabled_)|<details><summary>Show details</summary><br>**Default**: **Off** (__)<br>**Standard**: **On** (__)<br>**Strict**: **On** (__)<br>**Comment**: For more information, see zzz.</details>|
