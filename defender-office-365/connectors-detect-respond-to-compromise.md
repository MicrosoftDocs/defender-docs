...
In [Microsoft Defender for Office 365](mdo-about.md) or [Baseline Email Protection for cloud mailboxes](eop-about.md), use **Alerts** and **Message trace** to look for the symptoms of connector compromise:
