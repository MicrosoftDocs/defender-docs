...
Users can report messages in Teams from chats, including those with external users, standard channels, and meeting conversations. Users can only report messages as malicious.
