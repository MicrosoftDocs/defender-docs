...
- **Create allow entries directly in the Tenant Allow/Block List**: Allow entries for domains & addresses, URLs can be created directly from the [Tenant Allow/Block List](tenant-allow-block-list-about.md). It's available in Microsoft 365 Worldwide, GCC, GCC High, DoD, and Office 365 operated by 21Vianet environments.
