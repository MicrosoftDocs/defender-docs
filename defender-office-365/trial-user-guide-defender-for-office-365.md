...
- How email is delivered to your Microsoft 365 organization as described in the following scenarios:
  ...
  - Mail from the internet flows directly into Microsoft 365, but your current subscription has only [Baseline Email Protection](eop-about.md) or [Defender for Office 365 Plan 1](mdo-about.md#defender-for-office-365-plan-1-vs-plan-2-cheat-sheet).
