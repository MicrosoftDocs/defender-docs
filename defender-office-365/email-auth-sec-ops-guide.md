...
|[Composite authentication (compauth)](email-authentication-about.md#composite-authentication)|Composite authentication. A proprietary Microsoft 365 technology that combines multiple email authentication signals.|
...
- **Who's responsible**: The **sender** or the **recipient**. The failure is due to the sender's domain not passing DMARC or the recipient's [configuration for integrating non-Microsoft security services with Microsoft 365](mdo-integrate-security-service.md) that caused DMARC to fail.
