...
This example sets the priority of the rule named Marketing Department to 2. AAll existing rules with priority less than or equal to 2 are decreased by 1 (their priority numbers are increased by 1).
