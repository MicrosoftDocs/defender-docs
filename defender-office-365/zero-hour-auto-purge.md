...
- **Message details**: Use [Threat Explorer](threat-explorer-real-time-detections-about.md) to filter in **All email** tab of Threat Explorer events by the value **ZAP** for the **Additional action** column.
