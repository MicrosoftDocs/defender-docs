...
With the growing complexity of attacks, it's even difficult for trained users to identify sophisticated phishing messages. Fortunately, the default email protections in Microsoft 365 and the additional features in Microsoft Defender for Office 365 can help.

## Default anti-phishing protection in Microsoft 365

All Microsoft 365 organizations with cloud mailboxes contain the following default features that help protect your organization from phishing threats:
...
- **Anti-phishing policies in Microsoft Defender for Office 365**:
  ...
  - For more information about the differences between anti-phishing policies in the default email protections in Microsoft 365 vs. anti-phishing policies in Defender for Office 365, see [Anti-phishing policies in Microsoft 365](anti-phishing-policies-about.md).
