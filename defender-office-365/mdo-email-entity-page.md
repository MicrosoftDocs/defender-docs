...
The _Email summary panel_ is the email details flyout that's available in many features in the built-in security features for all cloud mailboxes and in Defender for Office 365. The Email summary panel contains standardized summary information about the email message taken from the full details that are available on the Email entity page in Defender for Office 365.
