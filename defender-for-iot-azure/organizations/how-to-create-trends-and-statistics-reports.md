...
By default, results display detections for the current day. Select the :::image type="icon" source="media/how-to-generate-reports/filter-icon.png" border="false"::: **Filter** icon at the top left of each widget to change the date range. You can view data for up to a maximum of 14 days.
