...
If expected activities don't appear after you connect an app, see [Troubleshoot missing activities after connecting an app](troubleshooting-api-connectors-errors.md#troubleshoot-missing-activities-after-you-connect-an-app).
