...
1. In the pop-up, select **Disable App connector instance** to confirm the action.
...
|Event  |Source  |
|---------|---------|
|Defender for Cloud Apps policy administration changes     |  Defender for Cloud Apps Activity log       |
