...
1. In the next window, give the connector a descriptive name, and select **Next**.
    ...
    :::image type="content" source="media/connect-slack.png" alt-text="Screenshot that shows where to enter the instance name in the Defender portal.":::

1. In the **External Link** page, select **Connect Slack**.

    :::image type="content" source="media/connect-in-slack.png" alt-text="Screenshot that shows where to enter the external link and connect to Slack.":::
