...
1. To ban the app, select the ban icon at the end of the app row in the table. For example:
    ...
    ![Screenshot of the ban app confirmation dialog with user notification options.](media/ban-app.png)
...
1. To approve the app, select the approve icon at the end of the row in the table.
    ...
    ![Screenshot of the Approve app action icon used to allow the app.](media/approve-app.png)
