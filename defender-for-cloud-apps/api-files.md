...
| policy | array of strings | cabinetmatchedrulesequals, neq, isset, isnotset | Filter File matches and associuated governance tasks related to the specified policies |
