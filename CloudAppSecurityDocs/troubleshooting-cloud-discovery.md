...
|Log collector status: Disconnected | If you see this issue, it means no data has been received in the last 24 hours from any of the linked data sources. Please contact Microsoft Defender for Cloud Apps support and provide the log files for investigation. Our team will analyze the logs to identify when the last sync occurred and what caused the disconnection. |
