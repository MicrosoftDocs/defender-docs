...
The Executive Summary report has been redesigned. The updated report has been streamlined from 26 pages to 6 pages, providing a modern, cleaner design that highlights the most valuable and actionable information. For more details, see [How to generate a Cloud Discovery executive report](defender-cloud-apps/discovered-apps#generate-a-cloud-discovery-executive-report).

[How to generate a Cloud Discovery executive report](discovered-apps.md#generate-a-cloud-discovery-executive-report)
