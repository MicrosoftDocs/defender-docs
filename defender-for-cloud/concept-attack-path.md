---
title: Security explorer and attack paths in Microsoft Defender for Cloud
...
:::image type="content" source="media/concept-cloud-map/attack-path.png" alt-text="Diagram showing a sample attack path from an attacker to sensitive data.":::
