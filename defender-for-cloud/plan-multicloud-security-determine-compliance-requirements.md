---
title: Determine multicloud compliance requirements for AWS and GCP
...
After you enable [enhanced security features](/azure/defender-for-cloud/enhanced-security-features-overview) in a Defender plan, you can add other compliance standards to the dashboard. Regulatory compliance is available when you enable at least one Defender plan on the subscription where the multicloud connector is located.
