...
Once you locate these recommendations ([Review security recommendations](review-security-recommendations.md)), you can remediate them ([Implement security recommendations](implement-security-recommendations.md)).
