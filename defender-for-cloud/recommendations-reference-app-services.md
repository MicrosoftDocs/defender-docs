...
### Audit logging should be enabled on Amazon MQ broker
...
### Data at rest encryption with customer-managed keys should be enabled on Kinesis streams
...
### General logging should be enabled on Amazon MQ broker
