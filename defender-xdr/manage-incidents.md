...
- Detailed step by step log and KQL queries utilized during the investigation process.
...
1. From the three dots menu in the top right, select **Generate analyst notes**.
