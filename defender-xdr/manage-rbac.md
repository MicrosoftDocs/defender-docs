---
title: Microsoft Defender unified role-based access control (RBAC)
...
All permissions listed within the Microsoft Defender unified RBAC model align to permissions in the individual RBAC models to ensure backward compatibility. For more information on how the permissions align, see [Map permissions in Microsoft Defender unified role-based access control (RBAC)](compare-rbac-roles.md).
...
3. **Learn more about the Microsoft Defender unified RBAC model**
   - [Microsoft Defender unified RBAC permissions](custom-permissions-details.md)
