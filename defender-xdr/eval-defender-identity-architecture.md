...
:::image type="content" source="./media/defender/m365-defender-identity-architecture.svg" alt-text="A diagram that shows the architecture for Microsoft Defender for Identity." lightbox="./media/defender/m365-defender-identity-architecture.svg":::
