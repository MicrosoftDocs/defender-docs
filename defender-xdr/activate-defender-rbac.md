...
1. **Activate workloads**
    ...
    - Toggle each of the workloads one by one to activate (or deactivate) that workload.
...
2. **Workload settings**
    - Select **Workload settings** to Microsoft Defender XDR **Permission and roles** page.
    - Toggle each of the workloads one by one to activate (or deactivate) that workload.
