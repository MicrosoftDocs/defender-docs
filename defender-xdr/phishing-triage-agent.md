...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| View  agent results and teach agent through feedback | The same permissions as the agent (or higher), as described in [Phishing Triage Agent required permissions](#phishing-triage-agent-required-permissions). |
