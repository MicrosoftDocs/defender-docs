...
> [!IMPORTANT]
> The Phishing Triage Agent doesn't classify alerts that you suppress by using [alert tuning](investigate-alerts.md#tune-an-alert). Make sure the **Auto-Resolve - Email reported by user as malware or phish** alert tuning rule is disabled.
