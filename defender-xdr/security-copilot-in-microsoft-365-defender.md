...
[Microsoft Security Copilot](/security-copilot/microsoft-security-copilot) brings together the power of AI and human expertise to help security teams respond to attacks faster and more effectively. Copilot in Defender is available to users who have provisioned access to Security Copilot.
...
- Defender Chat experience is an open prompt chat assistant built into Microsoft Defender. It helps SOC analysts investigate threats, explore incidents, and answer security questions in plain language, without needing to navigate multiple screens or write complex queries. It isn't yet available in Australia or New Zealand.
...
### [Defender Chat experience](#tab/defender-chat)
...
Resolving incidents requires analysts to understand an attack to know what solutions are appropriate. Copilot recommends solutions through [guided responses](security-copilot-m365d-guided-response.md) that are specific to each incident.
...
To ensure that you have access to Copilot in Defender, see the [Security Copilot purchase and licensing information](/security-copilot/faq-security-copilot). After you have access to Security Copilot, the key features become available in the Microsoft Defender portal.
...
- [Security Copilot embedded experiences](/security-copilot/experiences-security-copilot)
