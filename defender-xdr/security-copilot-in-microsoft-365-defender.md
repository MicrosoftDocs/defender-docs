...
Copilot in Defender operates using [Microsoft's AI principles](https://www.microsoft.com/ai/responsible-ai). To know more, see the [Responsible AI FAQs](responsible-ai-copilot-defender.md).
