...
- When a user account was created and whether the user account is of high, medium, or low criticality
- Unusual behavioral patterns related to sign in locations, sign in frequency, or frequency of failed sign in attempts
- A user’s current role, including their department and position, and whether there are role changes, comparing role additions and deletions with the user’s job title and department to highlight inconsistencies
- Data about a user’s last sign in to a device, whether or not the device is associated with to the user, in the last 30 days
