...
> [!NOTE]
> Make sure you have the right [permissions required for audit log search](/microsoft-365/compliance/audit-log-search#before-you-search-the-audit-log).
...
In addition to using Audit New Search in the Microsoft Purview portal, you can use PowerShell cmdlets to search for audit logs. [Search the audit log with a PowerShell script](/microsoft-365/compliance/audit-log-search-script).
