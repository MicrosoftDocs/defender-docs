...
| **[CloudPolicyEnforcementEvents](advanced-hunting-cloudpolicyenforcementevents-table.md)** (Preview)| Policy enforcement evaluation decisions and metadata of security gating events for various cloud platforms protected by the organization's Microsoft Defender for Cloud |	No|	No|
