...
- [Defender Chat experience](./security-copilot-in-microsoft-365-defender.md#defender-chat-experience-preview) (Preview) is an open prompt chat assistant built into Microsoft Defender. It helps SOC analysts investigate threats, explore incidents, and answer security questions in plain language, without needing to navigate multiple screens or write complex queries.
