...
- (GA) You can now view how Security Copilot came up with the query suggestion in its reponses in Microsoft Defender advanced hunting. Select **See the logic behind the query** below the query text to view Copilot's reasoning behind the query.
