...
## September 2024
- (GA) **Advanced hunting context panes** are now available in more experiences. This allows you to access the advanced hunting feature without leaving your current workflow. For incidents and alerts generated by analytics rules, you can select **Run query** to explore the results of the related analytics rule. For analytics rules, you can [UPDATE]. In the [query resources report](advanced-hunting-limits.md#find-resource-heavy-queries), you can also view any of the queries by selecting the three dots on the query row and selecting **Open in query editor**. [UPDATE FOR GO HUNT]
