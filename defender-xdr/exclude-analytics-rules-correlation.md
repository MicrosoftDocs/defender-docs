...
Conversely, when you include an analytics rule for correlation, the correlation engine processes any alert generated by that rule. This inclusion is controlled by adding the `#INC_CORR#` tag to the beginning of the rule's description.-->
