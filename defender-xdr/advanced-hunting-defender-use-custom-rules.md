...
You can also select the vertical ellipses ( ![Screenshot of the More options menu icon used to access additional function actions in advanced hunting.](/defender/media/ah-kebab.png) ) to the right of the function and select **Insert to query** to insert the function into a query in the query editor. 
