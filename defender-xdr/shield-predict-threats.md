...
| Behavioral analysis | A new privileged local account is created, signaling hands-on-keyboard activity. This triggers [automatic containment](../defender-endpoint/respond-machine-alerts.md#contain-user-from-the-network) of the user involved. | Automatic attack disruption | Incident graph to trace lateral movement |
