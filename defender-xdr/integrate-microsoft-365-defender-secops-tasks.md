...
## Maintain your SOC for Microsoft Defender

Here are the periodic or as-needed tasks to maintain your SOC for Microsoft Defender. The following table outlines each recurring activity, its recommended cadence, and the team typically responsible for it. Use these tasks to ensure your security operations center stays aligned with Microsoft Defender capabilities.

|Activity|Description|Cadence|Team assigned|
|---|---|---|---|
|Service administration collaboration with SOC Teams|Administration of peripheral services such as asset tracking (CMDB), application licensing (new SaaS licenses), device purchases (upgrades or renew device deployments),  and other Microsoft 365 tenant-wide changes (Intune, Microsoft 365, and others) that may affect deployment of Microsoft Defender products.|Weekly and as needed|Engineering & SecOps|
...
|Deploy automation scripts and services where appropriate|Download and test automation scripts and configuration files from approved Microsoft sites to improve Microsoft Defender operations.|Weekly and as needed|Engineering and SecOps|
