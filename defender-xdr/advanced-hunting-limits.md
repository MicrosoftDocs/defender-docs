...
In the unified Microsoft Defender portal, you are able to run queries over Microsoft Sentinel tables by onboarding a workspace. [Log analytics workspace limits](../azure/azure-monitor/service-limits.md#log-analytics-workspaces) therefore also apply. 
