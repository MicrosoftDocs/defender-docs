...
>[!IMPORTANT]
>Third-party network signal enrichment is deprecated in favor of Microsoft Defender Experts MDR Plan 2, effective September 1, 2026, and is closed to new enablement. If enrichment is enabled for your organization, coverage continues until your next renewal and ends at renewal. For expert-led coverage of non-Microsoft sources, contact your Microsoft account team about [Defender Experts MDR Plan 2](defender-experts-mdr-overview.md#defender-experts-mdr-plan-2).
...
>[!IMPORTANT]
>Enrichment coverage is only for network signal use and doesn't include the triage or investigation of incidents and alerts generated by third-party network solutions.
>
...
This capability is closed to new enablement. If third-party network signal enrichment is already enabled for your organization, [reach out to your Security Delivery Expert](defender-experts-mdr-communication.md#collaborating-with-your-security-delivery-expert) with questions about your existing coverage.
...
Not as part of network signal enrichment. Enrichment coverage is only for network signal use and doesn't include the triage or investigation of incidents and alerts generated by third-party network solutions. Defender Experts MDR Plan 2 does include triage and investigation of approved third-party and multicloud sources. [Learn more about the Defender Experts MDR plans](defender-experts-mdr-overview.md).

We initiate investigations with Microsoft Defender and Microsoft Defender for Servers incidents. Upon joining a network signal with these incidents, we conduct thorough investigations on the network alerts or events that are related to the threat. Incorporating these related network signals allows us to present a more comprehensive attack chain to our customers.
