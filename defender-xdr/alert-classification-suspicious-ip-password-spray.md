...
- Look at the [activity filters in Defender for Cloud Apps](/defender-cloud-apps/activity-filters) that originated from the IP:
...
5. [Require MFA for users](/microsoft-365/admin/security-and-compliance/multi-factor-authentication-microsoft-365) if possible to [enable Azure MFA](/azure/active-directory/authentication/tutorial-enable-azure-mfa) and make account compromise by a password spray attack difficult for the attacker.
