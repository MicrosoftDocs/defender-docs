...
You can transition without affecting your existing Defender for Endpoint workflows. Saved queries remain intact, and custom detection rules continue to run and generate alerts. Saved queries and custom detection rules will, however, be visible in Microsoft Defender XDR.
