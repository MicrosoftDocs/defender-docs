...
The following query finds recent `DeviceAlertEvents` records in Microsoft Defender for Endpoint that are associated with PowerShell technique T1086 and involve _powershell.exe_:
