...
| **Can I get Defender Experts updates from Microsoft Defender XDR in Microsoft Teams?** | A two-way chat functionality is accessible through an incident's **Managed response** flyout panel in your Microsoft Defender portal.<br><br>Additionally, you get notifications when a Managed response is posted and can engage in real-time chat conversations with Defender Experts directly within Microsoft Teams. [Learn more about setting up Teams](get-started-xdr.md#receive-managed-response-notifications-and-updates-in-microsoft-teams)|
