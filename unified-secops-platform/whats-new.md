...
- [Multitenant portal tenant groups now renamed to content distribution profiles](#multitenant-portal-tenant-groups-now-renamed-to-content-distribution-profiles)

### Multitenant portal tenant groups renamed to content distribution profiles

In the Microsoft Defender multitenant portal, tenant groups are now renamed to **content distribution profiles**. Content distribution profiles enable you to distribute security content, including custom detection rules and endpoint security policies, at scale across all of your tenants. , based on categories like business groups or location. For example:
