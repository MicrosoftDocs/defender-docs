...
:::image type="content" source="media/threat-intel-overview/usx-threat-intel.png" alt-text="Screenshot of Threat intelligence section of the Microsoft Defender portal." lightbox="media/threat-intel-overview/usx-threat-intel.png":::
...
:::image type="content" source="media/threat-intel-overview/usx-threat-analytics.png" alt-text="The analyst report section of a threat analytics report" lightbox="media/threat-intel-overview/usx-threat-analytics.png":::
...
:::image type="content" source="media/threat-intel-overview/usx-intel-explorer.png" alt-text="Screenshot of Intel explorer page." lightbox="media/threat-intel-overview/usx-intel-explorer.png":::

_The **Intel explorer** page in the Microsoft Defender portal_

For more information, see [What is Microsoft Threat Intelligence?](/defender-xdr/defender-threat-intelligence).
...
:::image type="content" source="media/threat-intel-overview/usx-sentinel-new-stix-object.png" alt-text="Screenshot of Intel management add new STIX object feature." lightbox="media/threat-intel-overview/usx-sentinel-new-stix-object.png":::
